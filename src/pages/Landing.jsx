...
//       {/* ── Stats Bar ── */}
//       <section className="py-5 px-4 bg-slate-850">
...
//               <p className="text-xs text-skyblue-400 mt-0.5">{s.label}</p>
//             </div>
//           ))}
//         </div>
//       </section>
...
//       {/* ── Features ── */}
//       <section className="py-15 px-4 bg-slate-50">
//         <div className="max-w-7xl mx-auto">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative px-4 py-10 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10" style={{background: "linear-gradient(135deg, #e0f0ff 0%, #f0f7ff 40%, #e8f4ff 70%, #dbeafe 100%)"}} />
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-4">
                ...
                <span className="text-primary relative inline-block">
                  AI-Assisted
                  <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 8" fill="none">
                    <path d="M0 6 Q75 0 150 4 Q225 8 300 2" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" fill="none" opacity="0.5"/>
                  </svg>
                </span>{" "}
                Clinical Insights
              </h1>
      ...
      {/* ── Stats Bar ── */}
      <section className="py-5 px-4" style={{background: "linear-gradient(90deg, #1e40af 0%, #2563eb 50%, #1d4ed8 100%)"}}>
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          {[
            { value: "4+", label: "Report Types" },
            { value: "< 30s", label: "Analysis Time" },
